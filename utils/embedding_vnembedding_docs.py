...
# Constants for local vnembedding model
...
def get_embedding(text):
    """
    Generate an embedding for the given text using the local vnembedding model.
    
    :param text: The input text to embed.
    :return: A list representing the embedding vector.
    """
    try:
        # Generate embedding using the vnembedding model
...
def search_docs_vnembedding(query: str, top_k=3):
    """
    ...
    DATA_PATH = "datasets/stores_embedding_vnembedding.csv"
...
if __name__ == "__main__":
    ...
    output_csv_path = "datasets/stores_embedding_vnembedding.csv"
    ...
    top_results = search_docs_vnembedding(user_input, top_k=3)
